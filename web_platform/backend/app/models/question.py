...
class SuggestedQuestion(Base):
    ...
    doctor_id = Column(String(36), ForeignKey("doctors.id", ondelete="CASCADE"), nullable=True)  # Null for default questions
    question = Column(String(512), nullable=False)
    is_default = Column(Boolean, default=False, nullable=False)  # True for system defaults
