...
export function toUiToolExecutionLog(log: ApiToolExecutionLogResponse): ToolExecutionLog {
...
export function toUiToolExecutionResult(result: ApiToolExecutionResultResponse): ToolExecutionResult {
    return {
        id: result.id,
...
export function toUiPatientWithStats(patient: ApiPatientWithStats): PatientWithStats {
    return {
        id: patient.id,
...
export function toUiMemoryStats(stats: ApiMemoryStatsResponse): import('../api/memory').MemoryStats {
    return {
...
export function toUiClearMemoryResponse(response: ApiClearMemoryResponse): import('../api/memory').ClearMemoryResponse {
    return {
...
export function toUiSystemCleanupStats(response: ApiSystemCleanupStatsResponse): import('../api/memory').SystemCleanupStats {
    return {
        success: response.success,
        message: response.message,
        stats: {
...
export function toUiTool(tool: ApiToolInfo): import('../api/toolManagement').Tool {
    return {
        id: tool.id,
        name: tool.name,
        description: tool.description,
        status: tool.status as 'available' | 'unavailable' | 'loaded' | 'unloaded' | 'error' | 'loading',
