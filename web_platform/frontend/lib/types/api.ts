...
/** Tool execution log */
export type ApiToolExecutionLogResponse = components['schemas']['ToolExecutionLogResponse'];

/** Tool execution result */
export type ApiToolExecutionResultResponse = components['schemas']['ToolExecutionResultResponse'];

/** Tool execution detail (execution + logs + result) */
export type ApiToolExecutionDetailResponse = components['schemas']['ToolExecutionDetailResponse'];
...
export type ApiToolBulkLoadRequest = components['schemas']['ToolBulkLoadRequest'];

/** Tool bulk load response */
export type ApiToolBulkLoadResponse = components['schemas']['ToolBulkLoadResponse'];

/** Memory statistics response */
export type ApiMemoryStatsResponse = components['schemas']['MemoryStatsResponse'];

/** Clear memory response */
export type ApiClearMemoryResponse = components['schemas']['ClearMemoryResponse'];

/** System cleanup statistics response */
export type ApiSystemCleanupStatsResponse = components['schemas']['SystemCleanupStatsResponse'];
