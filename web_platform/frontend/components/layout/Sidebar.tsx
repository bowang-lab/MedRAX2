...
export function Sidebar() {
    ...
    const loadPatients = async () => {
        ...
        try {
            ...
            const errorMessage = (error as { message?: string })?.message || 'Failed to load patients';
    ...
    useEffect(() => {
        loadPatients();
        // Only run once on mount (intentionally empty deps to prevent re-fetching)
    ...
    const handleDeletePatient = async (patientId: string) => {
        if (!confirm('Are you sure you want to delete this patient and all their chats?')) return;
